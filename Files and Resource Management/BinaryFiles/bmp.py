...
def write_grayscale(filename, pixels):
    ...
    :param filename: The name of the BMP file to me created.
    ...
    with open(filename, 'wb') as bmp:
        # BMP Header
        bmp.write(b'BM')    # This characters identify BMP file.

        size_bookmark = bmp.tell()      # The next four bytes the filesize as a 32-bit
        ...
        # Image header
        bmp.write(b'\x28\x00\x00\x00')  # Image header size in bytes - 40 decimal (0x28)
...
def dimensions(filename):
    ...
    :param filename: The filename of a BMP file.

    :return: A tuple, containing two integers with the width a
