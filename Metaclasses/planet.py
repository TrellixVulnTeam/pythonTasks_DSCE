...
class Positive(Named):
    ...
    def __set__(self, instance, value):
        if value <= 0:
            raise ValueError("Attribute value {} {} is not positive."
...
class Planet(metaclass=DescriptorNamingMeta):
    ...
    # Bind descriptor instance to class attribute
...
def main():
    ...
    mars = Planet("Mars",
                  ...
                  orbital_period_seconds=5.9354e7,
